CREATE DATABASE IF NOT EXISTS `dx`;
USE `dx`;
DROP TABLE IF EXISTS `art_tag`CREATE TABLE `art_tag` (
...
DROP TABLE IF EXISTS `nav`CREATE TABLE `nav` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `nav_art`CREATE TABLE `nav_art` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tag`CREATE TABLE `tag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
